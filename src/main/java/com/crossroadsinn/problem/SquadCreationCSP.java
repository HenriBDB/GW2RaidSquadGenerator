...
//
//import com.crossroadsinn.problem.entities.BoonCounter;
...
// * @version 1.0
// */
//public class SquadCreationCSP implements CSP {
...
//    private Hashtable<BoonCounter.Boon, Integer> reqBoons = new Hashtable<>();
...
//
//
//    public SquadCreationCSP(ArrayList<Integer[]> trainees, ArrayList<Integer[]> trainers, Hashtable<String, Integer> squadTypeAllowed) {
//        this(trainees, trainers, 0,squadTypeAllowed);
//    }
//
//    public SquadCreationCSP(ArrayList<Integer[]> trainees, ArrayList<Integer[]> trainers, int numSquads, Hashtable<String, Integer> squadTypeAllowed) {
...
//					this.reqBoons = new Hashtable<>();
//					this.reqSpecialRoles = new Hashtable<>();
//				}
//				i++;
//			}
//			if (!foundSquads) {
...
//     */
//    public SquadCreationCSP(SquadCreationCSP other) {
...
//		this.reqBoons = cloneBoonTable(other.reqBoons);
...
//	}
//
//	public Hashtable<BoonCounter.Boon, Integer> cloneBoonTable(Hashtable<BoonCounter.Boon, Integer> original) {
//		Hashtable<BoonCounter.Boon, Integer> copy = new Hashtable<>();
//		for(Map.Entry<BoonCounter.Boon, Integer> entry : original.entrySet()) {
//			copy.put(entry.getKey(), entry.getValue());
//		}
//		return copy;
//	}
...
//		}
//		// enough boons still available
//		for (BoonCounter.Boon boon:Roles.getRole(playerRole).getBoons().keySet()) {
//			if (Roles.getRole(playerRole).getBoonAmount(boon) > reqBoons.get(boon)) return false;
//		}
//
//        // Find player
//        Integer[] player = null;
...
//            for (int role : Roles.getAllRolesNumbers() ) {
//                if ((player[1] & role) > 0 ) {
//                    SquadCreationCSP copy = new SquadCreationCSP(this);
...
//     */
//    public boolean equals(SquadCreationCSP other) {
...
//				availBoons.replaceAll((b, v) -> availBoons.get(b) - Roles.getRole(role).getBoonAmount(b));
//				availSpecialRoles.replaceAll((r, v) -> availSpecialRoles.get(r) - Roles.getRole(role).getIfRole(r));
//			}
//		}
//    }
//
...
////			}
////		}
////		for (BoonCounter.Boon key:reqBoons.keySet()) {
